...
values = json.load(open("/home/christopher/Github/turo_arbitrage/dataset/data.json"))
...
cursor.execute("""CREATE TABLE turodb(
  ...
  ,location_precision_accuracy                     TEXT
  ,responseTime                                    TEXT
  ,rate_monthly                                    TEXT
  ,owner_image_thumbnails_84x84                    TEXT
  ,vehicle_marketCountry                           TEXT
  ,vehicle_listingCreatedTime                      TEXT
  ...
  ,owner_lastName                                  TEXT
  ,rate_averageDailyPriceWithCurrency_amount       TEXT
