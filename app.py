...
def getSingleVehicle(id_val):
	info = {}
	f = ['vehicle_name', 'rate_daily', 'location_address', 'vehicle_image_thumbnails_620x372', 'vehicle_year']
	e = turo.search()
